...
var matrix = [
    ...
    [4, 1, 3, 3, 0, 2, 0, 4, 1, 0, 0, 2, 1, 2, 1, 1, 1],
    [4, 1, 0, 3, 0, 1, 0, 4, 1, 0, 1, 2, 1, 2, 1, 1, 1],
    [4, 1, 0, 3, 0, 1, 0, 4, 1, 0, 1, 2, 1, 2, 1, 1, 1],
    [4, 1, 0, 3, 0, 1, 0, 4, 1, 0, 0, 2, 1, 2, 1, 1, 1],
    [4, 1, 0, 3, 0, 1, 0, 4, 1, 0, 0, 2, 1, 2, 3, 1, 1],
    [4, 0, 0, 3, 0, 1, 0, 4, 1, 0, 0, 1, 1, 1, 1, 1, 1],
    [4, 0, 0, 3, 0, 1, 0, 4, 1, 0, 0, 1, 1, 1, 1, 1, 1],
    [4, 0, 0, 3, 0, 1, 5, 4, 1, 0, 3, 1, 1, 1, 1, 1, 1],
    [4, 3, 0, 3, 0, 1, 5, 4, 1, 0, 0, 1, 1, 1, 1, 1, 1],
    [4, 3, 0, 3, 3, 1, 5, 4, 1, 1, 1, 1, 1, 1, 1, 1, 1],
    [4, 0, 0, 3, 0, 1, 5, 4, 1, 2, 2, 1, 1, 1, 1, 1, 1],
    [4, 1, 1, 1, 0, 1, 5, 4, 2, 2, 2, 1, 1, 1, 1, 1, 1]
]
    ...
    for (var y = 0; y < matrix.length; y++) {
        for (var x = 0; x < matrix[y].length; x++) {
            if (matrix[y][x] == 2) {
                ...
                var predatorarr = new Predator(x, y, 3);
                eateatArr.push(predatorarr);


            }
                        else if (matrix[y][x] == 4) {
                var angrystrangerarr = new Angrystranger(x, y, 4);
                eatbotheatArr.push(angrystrangerarr);
            }
            else if (matrix[y][x] == 5) {
                var doubleAngrystrangerarr = new DoubleAngrystranger(x, y, 5);
                eatemallarr.push(doubleAngrystrangerarr);
